...
public class Robot extends CommandRobotBase {
	...
	public void teleopExecute() {
		...
		SmartDashboard.putBoolean(SmartDashboardKey.FLYWHEEL_STATE.key, RobotMap.Component.flywheel.isSpunUp());
		...
		SmartDashboard.putBoolean(SmartDashboardKey.SHOOT_READY.key, SmartDashboard.getBoolean(SmartDashboardKey.HOOD_STATE.key) && SmartDashboard.getBoolean(SmartDashboardKey.FLYWHEEL_STATE.key));
	}
