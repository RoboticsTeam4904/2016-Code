...
public class RobotMap {
	...
	public static class Constant {
		...
		public static class Autoalign {
			...
			public static final double CAMERA_HEIGHT_PIXELS = 540; // idk. Placeholder
			...
			public static final double MOUNT_OFFSET_X = 336.55; // 13.25 inches in mm
			public static final double MOUNT_OFFSET_Y = Constant.CAMERA_DISTANCE_FROM_FRONT_BUMPER;// 63.5; // 2.5 inches in mm
			public static final double GOAL_HEIGHT = 2438.4; // 8 feet in mm
