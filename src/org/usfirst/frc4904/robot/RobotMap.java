...
public class RobotMap {
	...
	public static class Component {
		...
		public static MotionController timPID;
	...
	public RobotMap() {
		...
		Component.timPID = new CustomPIDController(Constant.TIM_P, Constant.TIM_I, Constant.TIM_D, Component.timEncoder);
		Component.timPID.setAbsoluteTolerance(Constant.TIM_ABSOLUTE_TOLERANCE);
		Component.tim = new Tim(Component.timPID, Component.timEncoder, new CANTalon(Port.CANMotor.timIntake), new CANTalon(Port.CANMotor.tim));
