...
import org.usfirst.frc4904.autonomous.commands.GoalAlignDistance;
...
public class NathanGain extends Driver {
	...
	public void bindCommands() {
		RobotMap.HumanInput.Driver.xbox.x.onlyWhileHeld(new GoalAlignDistance(RobotMap.Component.chassis, RobotMap.Component.leftWheelEncoder, false));
		...
		RobotMap.HumanInput.Driver.xbox.lb.onlyWhileHeld(new MotorControl(RobotMap.Component.tim, RobotMap.HumanInput.Driver.xbox, RobotMap.Constant.HumanInput.XBOX_360_RIGHT_STICK_Y));
	}
