...
import org.usfirst.frc4904.robot.commands.TimOverride;
...
public class NathanGain extends Driver {
	...
	public void bindCommands() {
		RobotMap.HumanInput.Driver.xbox.x.onlyWhileHeld(new GoalAlign(RobotMap.Component.chassis, RobotMap.Component.camera, false));
		...
		RobotMap.HumanInput.Driver.xbox.lb.onlyWhileHeld(new TimOverride(RobotMap.Component.tim, RobotMap.HumanInput.Driver.xbox, RobotMap.Constant.HumanInput.XBOX_360_RIGHT_STICK_Y, 1.5));
	}
