...
public class DefaultOperator extends Operator {
	...
	public void bindCommands() {
		...
		RobotMap.HumanInput.Operator.stick.button1.whenReleased(new RunAllSequential(new WaitCommand(RobotMap.Constant.HumanInput.HOODDOWN_AFTER_TRIGGERRELEASE_DELAY_SECONDS), new HoodDown()));
