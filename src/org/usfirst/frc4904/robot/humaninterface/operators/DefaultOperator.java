...
public class DefaultOperator extends Operator {
	...
	public void bindCommands() {
		...
		// RobotMap.HumanInput.Operator.stick.button3.whenPressed(new RockToShoot(RobotMap.Component.rocker));
		// RobotMap.HumanInput.Operator.stick.button5.whenPressed(new RockToIntake(RobotMap.Component.rocker));
